...
public class ZooGlobalExceptionHandler {
    ...
    public ResponseEntity<ZooErrorResponse> handleException(ZooException exception){
        ZooErrorResponse zooErrorResponse = new ZooErrorResponse(exception.getLocalizedMessage(), exception.getHttpStatus().value(), System.currentTimeMillis());
    ...
    public ResponseEntity<ZooErrorResponse> handleException(Exception exception){
        ZooErrorResponse zooErrorResponse = new ZooErrorResponse(exception.getLocalizedMessage(), HttpStatus.INTERNAL_SERVER_ERROR.value(), System.currentTimeMillis());
        log.error("Exception occured= ", exception);
